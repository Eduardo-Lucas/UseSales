...
public class PrimeiroAcesso extends Activity {

    public static final String TAG = PrimeiroAcesso.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iniciaProcesso.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isOnline()) {
                    Toast.makeText(PrimeiroAcesso.this, "Dispositivo sem Conexão com a Internet.",
...
//            dialog0 = ProgressDialog.show(PrimeiroAcesso.this, "Aguarde...", "Acessando " +
...
//            if (empresa != null) {
//                Toast.makeText(PrimeiroAcesso.this, "Novo recurso Empresa: " + empresa.getNome()
...
//    }
    ...
    private class GetFormasPagamentosTask extends AsyncTask<Void, Void, FormasPagamento> {

        @Override
        protected void onPreExecute() {
            dialog1 = ProgressDialog.show(PrimeiroAcesso.this, "Aguarde...", "Acessando " +
        ...
        protected void onPostExecute(FormasPagamento formasPagamento) {
            ...
            if (formasPagamento != null) {
                Toast.makeText(PrimeiroAcesso.this, "Novo recurso Forma de Pagamento: " +
    ...
    private class PostPrazosPagamentosTask extends AsyncTask<Void, Void, PrazosPagamento> {
        ...
        @Override
        protected void onPreExecute() {
            dialog2 = ProgressDialog.show(PrimeiroAcesso.this, "Aguarde...", "Acessando " +
                    "tabela " +
        ...
        protected void onPostExecute(PrazosPagamento prazosPagamento) {
            ...
            if (prazosPagamento != null) {
                Toast.makeText(PrimeiroAcesso.this, "Novo recurso Prazo de Pagamento: " +
    ...
    private class PostClientesTask extends AsyncTask<Void, Void, Cliente> {
        ...
        @Override
        protected void onPreExecute() {
            dialog3 = ProgressDialog.show(PrimeiroAcesso.this, "Aguarde...", "Acessando " +
        ...
        protected void onPostExecute(Cliente cliente) {
            ...
            if (cliente != null) {
                Toast.makeText(PrimeiroAcesso.this, "Novo recurso Cliente: " +
    ...
    private class PostProdutosTask extends AsyncTask<Void, Void, Produto> {
        ...
        @Override
        protected void onPreExecute() {
            dialog4 = ProgressDialog.show(PrimeiroAcesso.this, "Aguarde...", "Acessando " +
        ...
        protected void onPostExecute(Produto produto) {
            ...
            if (produto != null) {
                Toast.makeText(PrimeiroAcesso.this, "Novo recurso Produto: " +
...
//        @Override
//        protected void onPreExecute() {
//            dialog5 = ProgressDialog.show(PrimeiroAcesso.this, "Aguarde...", "Acessando " +
...
//
//            if (usuario != null) {
//                Toast.makeText(PrimeiroAcesso.this, "Novo recurso Usuário: " +
...
//        @Override
//        protected void onPreExecute() {
//            dialog6 = ProgressDialog.show(PrimeiroAcesso.this, "Aguarde...", "Acessando " +
...
//
//            if (pedido != null) {
//                Toast.makeText(PrimeiroAcesso.this, "Novo recurso Pedido: " +
...
//        @Override
//        protected void onPreExecute() {
//            dialog7 = ProgressDialog.show(PrimeiroAcesso.this, "Aguarde...", "Acessando " +
...
//
//
//            PedidoItem pedidoItem = new PedidoItem(null, Long.valueOf(1),
//                    Long.valueOf(1), "0001", BigDecimal.valueOf(10.5), BigDecimal.valueOf(123.45),
...
//
//            if (pedidoItem != null) {
//                Toast.makeText(PrimeiroAcesso.this, "Novo recurso Item do Pedido: " +
//                        pedidoItem.getNumeroPedido(), Toast.LENGTH_SHORT).show();
//
//            }
//            dialog7.dismiss();
//
